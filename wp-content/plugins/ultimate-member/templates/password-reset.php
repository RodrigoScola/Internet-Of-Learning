...
<div class="um <?php echo esc_attr( $this->get_class( $mode ) ); ?> um-<?php echo esc_attr( $form_id ); ?>">
	...
	wp_redirect(site_url('confirmation/your-recovery-link-has-been-sent'));
		} elseif ( isset( $_GET['updated'] ) && 'password_changed' === sanitize_key( $_GET['updated'] ) ) { ?>
			...
			<?php } else { ?>
					...
					<div class="um-field um-field-block um-field-type_block">
						<div class="um-field-block">
							<div style="text-align:center;" class="black">
								<?php esc_html_e( 'It happens to the best of us. Please fill in your email address and we will send you a recovery link.', 'ultimate-member' ); ?>
							</div>
						</div>
					</div>
				<?php }
				...
				<div class="um-col-alt um-col-alt-b">
					...
					<div class="um-center">
						<input type="submit" value="<?php esc_attr_e( 'email me a recovery link', 'ultimate-member' ); ?>" class="um-button" id="um-submit-btn" />
					</div>
