<div class='password-change w-50 main-content  pt-3'>
     ...
     <ul class="list p-0">
          <li>
               <span class="icon text-sm   mh-03 dashicons blue dashicons-yes-alt"></span>
               <p class="text-sm">Is longer than 8 characters​</p>
          </li>
          <li>
               <span class="icon text-sm  mh-03 dashicons blue dashicons-yes-alt"></span>
               <p class="text-sm">Should not match or significantly contain parts of your email</p>
          </li>
          <li>
               <span class="icon text-sm  mh-03 dashicons blue dashicons-yes-alt"></span>
               <p class="text-sm">Is not reused on this or any other account</p>
          </li>
     </ul>
