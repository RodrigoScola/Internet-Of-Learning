<main class="main-content">
     <article class="hero">
          <section>
               ...
               <p class='text-md'>
                    Internet of learning will make your search <span class="text-md blue bold">easier</span> and <span class="text-md bold blue">hassle free</span>.

                    <br />
                    <br />

                    Whether youre a professional looking to level up your career, or a student looking to for personal development, the Internet of Learning connects you with the best courses led by expert-led educators.
               </p>
               [FindMyCourse]
          </section>
     ...
     <article class=" ph-1 pb-1 mb-3">

          <div>
               <h3 class="text-title text-md text-center bold ">Choose The Right Course To Upskill Your Career & Personal Life</h3>
               <article class="cards">
                    <section class="card">
     ...
     <div class='hero '>
          ...
          <div>
               <ul class='list_brain mt-2'>
                    ...
                    <li>
                         <p class="ml-06">95% of the course listed on our website offers a money-back guarantee so that you can be sure that you are satisfied with your purchase
                         </p>
                    </li>
                    <br />
                    <li>

                         <p class="ml-06">We offer a platform for you to connect with like-minded students and educators so that you can network and learn from each other.
                         </p>
                    </li>
                    <br />
     ...
     <div>
          <h1 class='text-md text-title text-center bold'>
               What They Say...
          </h1>
          <div class='cards'>
               <div class="card">
                    <h1 class="text-title text-xsm bold">Sarah, Berlim</h1>

                    <?php renderStars(1) ?>
                    <p class='quote'>I was on the search for a great marketing course for months and couldn't find anything that was interesting enough. But thanks to the Internet of Learning, I found the perfect course for me in just a few minutes! The detailed description of the course and the student reviews were really helpful.</p>
               </div>
               <div class="card">
                    <h1 class="text-title text-xsm bold">Mike, New York</h1>
                    <?php renderStars(5) ?>
                    <p class='quote'>The best website for courses i have ever come across! All the courses listed here are very comprehensive and the student reviews are always on point. I found the best art course led by my facourite artist on this website thank you Internet of Learning!</p>
               </div>
               <div class="card">
                    <h1 class="text-title text-xsm bold">David, Toronto </h1>
                    <?php echo renderStars(3) ?>
                    <p class=''>I was looking for an online course to improve my writing skills and thanks to the student reviews on this website, I found the perfect one. The teacher is great and I'm learning a lot. An awesome free resource to find online courses!</p>
               </div>
          </div>
     </div>
     ...
     <div>
          <h1 class='text-title text-center bold'>9/10 Students Were Able to Find the Right Course and Level Up Their Personal and Professional Life<h1>
     </div>
     <article class="cards ">
          <section class='card'>
