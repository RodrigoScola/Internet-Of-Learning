...
<div class="um main-content ph-4  <?php echo esc_attr($this->get_class($mode)); ?> um-<?php echo esc_attr($form_id); ?> um-role-<?php echo esc_attr(um_user('role')); ?> ">
     ...
     <div class="um-form" data-mode="<?php echo esc_attr($mode) ?>">
          ...
          do_action('um_profile_before_header', $aras);
          ...
          <?php }
               ...
               <div class="um-profile-body  <?php echo esc_attr($nav . ' ' . $nav . '-' . $subnav); ?>">
                    ...
                    <?php echo
                         ...
                         get_template_part('components/pages/profile/posts');
