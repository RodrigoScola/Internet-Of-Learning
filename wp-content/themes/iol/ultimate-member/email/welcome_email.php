...
<div style="text-align: center;font-weight: 600;font-size: 26px;padding: 10px 0;border-bottom: solid 3px #eeeeee">IOL</div>
...
<div style="padding: 20px">If you have any problems, please contact us at <a style="color: #3ba1da;text-decoration: none" href="mailto:{admin_email}">I</a>OL</div>
</div>
