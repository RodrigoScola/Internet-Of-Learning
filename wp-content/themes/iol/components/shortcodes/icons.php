...
class Icon
{
     ...
     function __construct($iconname, $iconhtml)
     {
          ...
          // createFile('/icons/' . $iconname . '.svg', $iconhtml, [
          //      'title' => str_replace('Icon', '', $iconname) . '.svg'
          // ]);
     ...
     function iconinit($atts = [])
     {
          ...
          ob_start();
?>
          <i id='<?php echo $buttonAtts['id'] ?>' class="<?php echo $buttonAtts['class']  . " " . $this->iconClass . " icon-" . $buttonAtts['size']  ?> "><?php echo $this->iconHtml ?></i>
...
function url_to_icon(string $url, $color = '')
{
     $root = parse_url($url, PHP_URL_HOST);
     $allowedIcons = ['twitter', 'facebook', 'google', 'youtube'];
     $root =
          $root =  str_ireplace('www.', '', $root);
     $root =   str_ireplace('.com', '', $root);
     if (!in_array($root, $allowedIcons))
          return null;
...
function initIcons()
{
     new Icon('IconTwitter', '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-twitter" viewBox="0 0 16 16">
  <path d="M5.026 15c6.038 0 9.341-5.003 9.341-9.334 0-.14 0-.282-.006-.422A6.685 6.685 0 0 0 16 3.542a6.658 6.658 0 0 1-1.889.518 3.301 3.301 0 0 0 1.447-1.817 6.533 6.533 0 0 1-2.087.793A3.286 3.286 0 0 0 7.875 6.03a9.325 9.325 0 0 1-6.767-3.429 3.289 3.289 0 0 0 1.018 4.382A3.323 3.323 0 0 1 .64 6.575v.045a3.288 3.288 0 0 0 2.632 3.218 3.203 3.203 0 0 1-.865.115 3.23 3.23 0 0 1-.614-.057 3.283 3.283 0 0 0 3.067 2.277A6.588 6.588 0 0 1 .78 13.58a6.32 6.32 0 0 1-.78-.045A9.344 9.344 0 0 0 5.026 15z"/>
</svg>');
     new Icon("IconGoogle", '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-google" viewBox="0 0 16 16">
  <path d="M15.545 6.558a9.42 9.42 0 0 1 .139 1.626c0 2.434-.87 4.492-2.384 5.885h.002C11.978 15.292 10.158 16 8 16A8 8 0 1 1 8 0a7.689 7.689 0 0 1 5.352 2.082l-2.284 2.284A4.347 4.347 0 0 0 8 3.166c-2.087 0-3.86 1.408-4.492 3.304a4.792 4.792 0 0 0 0 3.063h.003c.635 1.893 2.405 3.301 4.492 3.301 1.078 0 2.004-.276 2.722-.764h-.003a3.702 3.702 0 0 0 1.599-2.431H8v-3.08h7.545z"/>
</svg>');
     new Icon('IconFacebook', '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
  <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z"/>
</svg>');
     new Icon('IconYoutube', '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-youtube" viewBox="0 0 16 16">
...
');
     new Icon('IconDifficulty0', '<svg width="16" height="12" viewBox="0 0 16 12" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
');
     new Icon('IconDifficulty1', '<svg width="12" height="10" viewBox="0 0 12 10" fill="none" xmlns="http://www.w3.org/2000/svg">
...
');
     new Icon('IconDifficulty2', '<svg width="12" height="10" viewBox="0 0 12 10" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<path d="M0 6.5V5.75H-0.75V6.5H0ZM3 6.5H3.75V5.75H3V6.5ZM3 9.5V10.25H3.75V9.5H3ZM0 9.5H-0.75V10.25H0V9.5ZM4.5 3.5V2.75H3.75V3.5H4.5ZM7.5 3.5H8.25V2.75H7.5V3.5ZM7.5 9.5V10.25H8.25V9.5H7.5ZM4.5 9.5H3.75V10.25H4.5V9.5ZM9 0.5V-0.25H8.25V0.5H9ZM12 0.5H12.75V-0.25H12V0.5ZM12 9.5V10.25H12.75V9.5H12ZM9 9.5H8.25V10.25H9V9.5ZM0 7.25H3V5.75H0V7.25ZM2.25 6.5V9.5H3.75V6.5H2.25ZM3 8.75H0V10.25H3V8.75ZM0.75 9.5V6.5H-0.75V9.5H0.75ZM4.5 4.25H7.5V2.75H4.5V4.25ZM6.75 3.5V9.5H8.25V3.5H6.75ZM7.5 8.75H4.5V10.25H7.5V8.75ZM5.25 9.5V3.5H3.75V9.5H5.25ZM9 1.25H12V-0.25H9V1.25ZM11.25 0.5V9.5H12.75V0.5H11.25ZM12 8.75H9V10.25H12V8.75ZM9.75 9.5V0.5H8.25V9.5H9.75Z" fill="#282828" mask="url(#path-1-inside-1_2168_3193)"/>
     ...
     new Icon('IconDifficulty3', '<svg width="12" height="10" viewBox="0 0 12 10" fill="none" xmlns="http://www.w3.org/2000/svg">
...
');
     new Icon('IconDashboard', '<svg width="18" height="18" viewBox="0 0 18 18" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
<path d="M9.75 6.75V0H18V6.75H9.75ZM0 9.75V0H8.25V9.75H0ZM9.75 18V8.25H18V18H9.75ZM0 18V11.25H8.25V18H0ZM1.5 8.25H6.75V1.5H1.5V8.25ZM11.25 16.5H16.5V9.75H11.25V16.5ZM11.25 5.25H16.5V1.5H11.25V5.25ZM1.5 16.5H6.75V12.75H1.5V16.5Z" fill="currentColor"/>
</svg>
');
     new Icon("IconCheckMark", '<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
<rect width="20" height="20" rx="10" fill="#6252B0"/>
<g clip-path="url(#clip0_2_235)">
<path d="M13.885 5.10001L8.215 10.77L6.115 8.67001L4 10.785L8.215 15L16 7.21501L13.885 5.10001Z" fill="white"/>
</g>
<defs>
