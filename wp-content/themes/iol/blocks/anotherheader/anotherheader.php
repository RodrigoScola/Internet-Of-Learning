...
<header class='page-header'>
     <div class="page-header">
          ...
          <h1 class='title'>I<?php echo getBrain('white') ?>L</h1>
          <?php
          ...
          ?>
               <div class="search">
                    ...
                    <button class='btn btn-sm btn-yellow btn-round_right ' type="submit"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#00000" class="bi bi-search" viewBox="0 0 16 16">
                              <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z" />
                         </svg><span>Start Learning</span></button>
               </div>
          <?php  }
          ?>
     </div>
     <div class='page-header-container '>
          ...
          <button class='btn btn-md btn-yellow '>Claim My Course</button>
          <button class='btn btn-md btn-yellow-hollow btn-round '>Log in</button>
...
<footer class="footer">
     ...
     <div class='footer-section'>
          <div class='footer-item'>
               ...
               <p>Free course listing</p>
               <p>Premium Course listing</p>
               <p>Services for Courses</p>
               <p>Expert couse reviews</p>
               <p>Course insights</p>
          </div>
     </div>
     <div class='footer-section'>
