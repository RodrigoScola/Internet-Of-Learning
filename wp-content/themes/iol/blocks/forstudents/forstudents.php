...
<main>
     ...
     <article class="courses">
          ...
          <div>
               ...
               <div class='cards'>
                    <div class="card">
                         <h1 class="title title-xsm">Sarah, Berlim</h1>
                    ...
                    <div class="card">
                         <h1 class="title title-xsm">David, Toronto </h1>
                         <div class='stars-3'>
                              <span class="dashicons dashicons-star-filled star-1"></span>
                              <span class="dashicons dashicons-star-filled star-2"></span>
                              <span class="dashicons dashicons-star-filled star-3"></span>
                         ...
                         <p class=' subtitle quote'>I was looking for an online course to improve my writing skills and thanks to the student reviews on this website, I found the perfect one. The teacher is great and I'm learning a lot. An awesome free resource to find online courses!</p>
                    </div>
               </div>
          </div>
          ...
          <div>
               <h1 class='title'>9/10 Students Were Able to Find the Right Course and Level Up Their Personal and Professional Life<h1>
          </div>
          <article class="cards ">
               <section class='card'>
